...
export const messages = {
  ...
  en: {
    ...
    heroBadge: 'Turn webpages, documents, and images into clean materials for AI knowledge workflows', heroTitle: 'A clean Markdown entry point for AI agents', heroDescription: 'Webpages, articles, PDF, Word, PPT, Excel, images, and screenshots. Clean the source first, then send it to your AI workflow or knowledge tool.', quickExample: 'Try an example:', article: 'Web article', urlMode: 'Web URL to Markdown', htmlMode: 'Paste HTML source', urlPlaceholder: 'Paste a webpage URL...', htmlPlaceholder: 'Paste HTML source here...', parse: 'Convert to Markdown', parsing: 'Parsing...', parseHtml: 'Parse HTML source',
    ...
    docsTitle: 'HerdownDocs', docsSubtitle: 'Start with one URL and connect clean materials to your AI workflow.', quickStart: 'Quick start', apiDocs: 'API documentation', integrations: 'Workflow integrations', localTools: 'Local tools', security: 'Quota and security', docsStart: 'Open the homepage, paste a URL, and click Convert to Markdown.', docsApi: 'Create an API key on the API page, then use the RESTAPI, MCP, or CLI.', docsLocal: 'Use local MarkItDown for PDF, PPT, and Excel. Use the local Unlimited-OCRSkill for screenshots and scans.', docsWorkflow: 'Herdown creates clean materials. Dify, Coze, FastGPT, or n8n can handle the workflow that comes next.',
